...
import com.leaveme.notebook.DataModel.DaoMaster;
                ...
                ContextWrapper wrapper = new ContextWrapper(context) {
                    ...
                    public File getDatabasePath(String name) {
                        ...
                        if (!sdExist) {// 如果不存在,
                            ...
                            // 获取sd卡路径
                            String dbDir = context.getExternalFilesDir(null).getPath()+"/data";
//                            String dbDir = android.os.Environment.getExternalStorageDirectory().getAbsolutePath();
//                            dbDir += "/Android/data/com.leaveme.notebook";// 数据库所在目录
...
//                daoMaster = new DaoMaster(helper.getEncryptedWritableDb("1234"));//获取可读写的加密数据库
    ...
    private static class MySQLiteOpenHelper extends DaoMaster.OpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            MigrationHelper.migrate(db,NoteDao.class, NoteDao.class);
    ...
    private static class MyEncryptedSQLiteOpenHelper extends DaoMaster.OpenHelper {
        ...
        public void onUpgrade(Database db, int oldVersion, int newVersion) {
            ...
            EncryptedMigrationHelper.migrate((EncryptedDatabase) db,NoteDao.class,
                    NoteDao.class);
            Log.e(UPGRADE,"upgrade run success");
        }
